...
contract CommonUtilities is ICommonUtilities {
    function toString(address _addr)
        public
        override
        pure
    ...
    function toString(uint256 _i) public override pure returns (string memory) {
        if (_i == 0) {
            return "0";
        }
        uint256 j = _i;
    ...
    function toUint256(bytes memory bs)
        public
        override
        pure
        returns (uint256 x)
    ...
    function toAddress(bytes memory b)
        public
        override
        pure
