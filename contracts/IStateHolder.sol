...
interface IStateHolder {
     ...
     * @return true if varName is set, false otherwhise
     */
     ...
     */
    function getDataType(string calldata varName)
        external
        view
    ...
    function setBytes(string calldata varName, bytes calldata val)
        external
        returns (bytes memory);

    function getBytes(string calldata varName)
        external
        view
        returns (bytes memory);
    ...
    function getString(string calldata varName)
        external
        view
        returns (string memory);
    ...
    function getUint256(string calldata varName)
        external
        view
        returns (uint256);

    function setUint256(string calldata varName, uint256 val)
        external
        returns (uint256);

    function getAddress(string calldata varName)
        external
        view
        returns (address);
